...
const SentimentAnalysis = () => {
    ...
    return (
    <div className="min-h-screen pt-16 bg-gray-100 dark:bg-gray-900 text-black dark:text-white flex flex-col items-center px-4 mt-10">
    ...
    {result && !loading && (
        <div className="mt-10 w-full max-w-6xl grid md:grid-cols-2 gap-6 mb-10">
